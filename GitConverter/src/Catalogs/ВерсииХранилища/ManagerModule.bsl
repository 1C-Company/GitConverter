...
// Сохраняет информацию об авторе версии хранилища 1с. 
// 
// Параметры:
//  Хранилище - СправочникСсылка.ХранилищаКонфигураций - Настройка для которой загружается отчет хранилища.
//  ВерсияХранилища - Структура - данные версии хранилища (см. ЗагрузитьВерсииИзОтчета).
//  ПользователиХранилища - ТаблицаЗначений - список пользователей хранилища 1С сохренненных в базе. 
