...
Процедура ПередЗаписью(Отказ)
	...
	Если Состояние <> Перечисления.СостоянияВерсии.ВерсияВыгружена
		И Состояние <> Перечисления.СостоянияВерсии.ЗагрузкаМетаданных
		И Состояние <> Перечисления.СостоянияВерсии.МетаданныеЗагружены
		И Состояние <> Перечисления.СостоянияВерсии.НачалоКоммита
		И Состояние <> Перечисления.СостоянияВерсии.ВерсияПомещена Тогда
