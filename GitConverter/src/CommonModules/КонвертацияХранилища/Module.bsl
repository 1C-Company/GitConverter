...
Функция ДобавитьМеткуСНомеромСборки(ПараметрыВерсии, РеквизитыХранилища)
	...
	МеткаСВерсией = ПолучитьИмяМеткиВерсии(ПараметрыВерсии, РеквизитыХранилища, НомерТекущейВерсии);
...
Функция ПолучитьИмяМеткиВерсии(ПараметрыВерсии, РеквизитыХранилища, НомерВерсии)
