...
Процедура СформироватьОтчетПоВерсиямХранилища(Параметры) Экспорт
	...
	Если Параметры.Свойство("СформироватьОтчетПоВерсиямХранилища")
		...
		Если КодВозврата <> 0 Тогда
			...
			ДобавитьЗаписьВЖурналРегистрации(НСтр("ru = 'Пакетная операция.Получение отчета из хранилища'"), "Ошибка", , НСтр("ru = 'Ошибка выполнения пакетной операции.'"), ТекстЛога);

			ВызватьИсключение "При формирования отчета по хранилищу конфигураций возникли ошибки (см. Журнал регистрации).";
