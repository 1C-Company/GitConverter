...
Процедура СоздатьРепозиторийGit(Хранилище, ЛогОперации, Клонировать = Ложь, СоздатьВетку = Ложь) Экспорт
	...
	ДобавитьЗаписьВЛог(Новый Структура("ИмяФайлаЛога", ФайлЛога), НСтр("ru = 'Начало инициализации Git репозитория'"));
	...
	ДобавитьЗаписьВЛог(Новый Структура("ИмяФайлаЛога", ФайлЛога), НСтр("ru = 'Окончание инициализации Git репозитория'"));
